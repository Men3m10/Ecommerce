            ...
            <View style={styles.productInfoContainer}>
              ...
              <View style={styles.productListBottomContainer}>
                <View style={{ width: "45%" }}>
                  <Text style={styles.productPrice}>
                    {(price * quantity).toString().length >= 15
                      ? (price * quantity).toString().substring(0, 5) + "..."
                      : price * quantity}{" "}
                  </Text>
                </View>
                ...
                <View style={styles.counter}>
                  <TouchableOpacity
                    style={styles.MinusCounterButtonContainer}
                  ...
                  <TouchableOpacity
                    style={styles.PlusCounterButtonContainer}
