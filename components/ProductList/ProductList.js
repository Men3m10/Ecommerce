      ...
      <View style={styles.innerContainer}>
        ...
        <View style={styles.productInfoContainer}>
          ...
          <View style={styles.productInfoItem}>
            <Text style={styles.productInfoItemText}>الفئه: </Text>
            <Text>
              {category.length > 17
          ...
          <View style={styles.productInfoItem}>
            <Text style={styles.productInfoItemText}>السعر: </Text>
            <Text>
              {" "}
          ...
          <View style={styles.productInfoItem}>
            <Text style={styles.productInfoItemText}>حفظ: </Text>
            <Text>
              {qantity <= 0
                ? "Out of Stock"
                : qantity.length > 17
                ? qantity.substring(0, 7) + "..."
                : qantity}
            </Text>
          </View>
        </View>
