...
import CarOrderList from "../../components/CarOrderList/CarOrderList";

I18nManager.forceRTL(true);
I18nManager.allowRTL(true);

const ViewCarOrdersScreen = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.screenNameContainer}>
        <View>
          <Text style={styles.screenNameText}>مشاهدة الطلب</Text>
        </View>
        <View>
          <Text style={styles.screenNameParagraph}>عرض جميع الطلبات</Text>
        </View>
      </View>
      ...
      >
        {foundItems && foundItems.length == 0 ? (
          <Text>{`لم يتم العثور علي هذا الطلب ${filterItem}!`}</Text>
        ) : (
...
export default ViewCarOrdersScreen;
