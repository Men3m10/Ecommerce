  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.screenNameContainer}>
        <View>
          <Text style={styles.screenNameText}>عرض المستخدمين</Text>
        </View>
        <View>
          <Text style={styles.screenNameParagraph}>عرض جميع المستخدمين</Text>
        </View>
      </View>
      ...
      >
        {foundItems && foundItems.length == 0 ? (
          <Text>{`لم يتم العثور على مستخدم باسم ${filterItem}!`}</Text>
        ) : (
