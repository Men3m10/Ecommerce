          ...
          <View style={styles.productInfoTopContainer}>
            ...
            <View style={styles.productDetailContainer}>
              ...
              <View style={styles.productPriceContainer}>
                <Text style={styles.secondaryTextSm}>السعر:</Text>
                <Text style={styles.primaryTextSm}>{product?.price} EGP</Text>
              </View>
            </View>
            <View style={styles.productDescriptionContainer}>
              <Text style={styles.secondaryTextSm}>الوصف:</Text>
          ...
          <View style={styles.productInfoBottomContainer}>
            ...
            <View style={styles.productButtonContainer}>
              {avaiableQuantity > 0 ? (
                ...
                <CustomButton text={"إنتهى من المخزن"} disabled={true} />
              )}
            </View>
          </View>
        </View>
