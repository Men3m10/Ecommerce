...
const MyOrderDetailScreen = ({ navigation, route }) => {
  ...
  const customStyles = {
    ...
    separatorFinishedColor: "#539357",
    separatorUnFinishedColor: "#aaaaaa",
    stepIndicatorFinishedColor: "#539357",
    stepIndicatorUnFinishedColor: "#ffffff",
    stepIndicatorCurrentColor: colors.white,
    stepIndicatorLabelFontSize: 13,
    currentStepIndicatorLabelFontSize: 13,
    stepIndicatorLabelCurrentColor: "#539357",
    stepIndicatorLabelFinishedColor: "#ffffff",
    stepIndicatorLabelUnFinishedColor: "#aaaaaa",
    labelColor: "#999999",
    labelSize: 13,
    currentStepLabelColor: "#539357",
  };
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.containerNameContainer}>
          <View>
            <Text style={styles.containerNameText}>عنوان الشحن</Text>
          </View>
        </View>
        ...
        <View style={styles.orderItemsContainer}>
          ...
          <View style={styles.orderItemContainer}>
            <Text style={styles.orderItemText}>
              تم الطلب : {orderDetail?.updatedAt}
            </Text>
          </View>
          <ScrollView
